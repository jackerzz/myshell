...
do
  ...
  case  $index  in
	...
	21 ) $filepath/app/es/es.sh;;
	22 ) $filepath/app/golang/golang.sh;;
	23 ) $filepath/app/keepalived/keepalived.sh;;
	24 ) $filepath/app/v2ray/V2Ray_ws_tls.sh;;
	25 ) $filepath/app/trojan_mult/trojan_mult.sh;;
	26 ) $filepath/app/wrk/wrk.sh;;
	27 ) $filepath/app/done;;
    * ) show_menus;;
  esac
done
